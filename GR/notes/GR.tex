...
Note que se uma transição é do tipo $A \rightarrow \varepsilon$, fazemos do estado $A$ um estado final. 

\subsection{Algoritmo}
O procedimento está descrito no algoritmo~\ref{alg:converte}:
...
\begin{algorithm}[H]
  ...
  \begin{algorithmic}[1]
    ...
    \State $q_f \leftarrow$ novo estado
    \State $Q \leftarrow V \cup \{q_f\}$
