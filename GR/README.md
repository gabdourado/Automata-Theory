...
| Arquivo | Descrição |
|---|---|
| `GLUD.cpp` | Simula GLUD convertendo para um AFND-ε e usando Backtracking |
...
|---|---|---|
| `IN1_GLUD.txt` | Palavras sobre {a,b} terminadas em "b" | `GLUD.cpp`|
| `IN2_GLUD.txt` | Palavras sobre {a,b} com quantidade par de a's | `GLUD.cpp`|
| `IN3_GLUD.txt` | Palavras sobre {0,1} que começam e terminam com mesmo símbolo | `GLUD.cpp`|
| `IN4_GLUD.txt` | Palavras sobre {a,b} que contém "ab" como substring | `GLUD.cpp`|
| `IN5_GLUD.txt` | Palavras sobre {a,b} que terminam com "aa" | `GLUD.cpp`|
| `IN6_GLUD.txt` | Palavras sobre {a,b} que não possuim dois símbolos consecutivos iguais | `GLUD.cpp`|
| `IN7_GLUD.txt` | Palavras sobre {a,b} que não contém "ab" como substring | `GLUD.cpp` |